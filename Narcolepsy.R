...
narcolepsy_current <- read_outcome_data(
  "GWASofNarcolepsyInCurrentSmokers_imputed.txt",
...
setwd("~/Desktop/MP1/Project portal/data/Unzipped stratified UK Biobank data for MVMR/Narcolepsy")

#b. Ever smokers
memory.limit(size = 80000)
narcolepsy_ever <- read_outcome_data(
  "GWASofNarcolepsyInEverSmokers_imputed.txt",
  snps = Exposures_H$SNP,
  sep="\t",
  snp_col = "SNP",
  beta_col = "BETA",
...
setwd("~/Desktop/MP1/Project portal/data/Unzipped stratified UK Biobank data for MVMR/Narcolepsy")
memory.limit(size = 80000)
narcolepsy_former <- read_outcome_data(
  "GWASofNarcolepsyInFormerSmokers_imputed.txt",
  snps = Exposures_H$SNP,
  sep="\t",
  snp_col = "SNP",
  beta_col = "BETA",
...
setwd("~/Desktop/MP1/Project portal/data/Unzipped stratified UK Biobank data for MVMR/Narcolepsy")
memory.limit(size = 80000)
narcolepsy_never <- read_outcome_data(
  "GWASofNarcolepsyInNeverSmokers_imputed.txt",
  snps = Exposures_H$SNP,
  sep="\t",
  snp_col = "SNP",
  beta_col = "BETA",
...
#a.
mvdat <- mv_harmonise_data(Exposures_H, narcolepsy_current, harmonise_strictness = 2)
mvdat_1<- harmonise_data(Exposures_H, narcolepsy_current)
mvdat_1<- mvdat_1[mvdat_1$mr_keep== TRUE, ]
str(mvdat_1)

#b.
mvdat <- mv_harmonise_data(Exposures_H, narcolepsy_ever, harmonise_strictness = 2)
mvdat_1<- harmonise_data(Exposures_H, narcolepsy_ever)
mvdat_1<- mvdat_1[mvdat_1$mr_keep== TRUE, ]
str(mvdat_1)

#c.
mvdat <- mv_harmonise_data(Exposures_H, narcolepsy_former, harmonise_strictness = 2)
mvdat_1<- harmonise_data(Exposures_H, narcolepsy_former)
mvdat_1<- mvdat_1[mvdat_1$mr_keep== TRUE, ]
str(mvdat_1)

#d.
mvdat <- mv_harmonise_data(Exposures_H, narcolepsy_never, harmonise_strictness = 2)
mvdat_1<- harmonise_data(Exposures_H, narcolepsy_never)
mvdat_1<- mvdat_1[mvdat_1$mr_keep== TRUE, ]
str(mvdat_1)
...
#a.
proxy_needed3 <- data.frame(setdiff(EXP1_H$SNP, narcolepsy_current$SNP))

#b.
proxy_needed3 <- data.frame(setdiff(EXP1_H$SNP, narcolepsy_ever$SNP))

#c.
proxy_needed3 <- data.frame(setdiff(EXP1_H$SNP, narcolepsy_former$SNP))

#d.
proxy_needed3 <- data.frame(setdiff(EXP1_H$SNP, narcolepsy_never$SNP))
...
#a.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Narcolepsy/Current")
write.csv(mod_ME_2_or,"No_UKB_Narcolepsy_current_MVMR_Egger.csv", row.names = TRUE)

#b.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Narcolepsy/Ever")
write.csv(mod_ME_2_or,"No_UKB_Narcolepsy_ever_MVMR_Egger.csv", row.names = TRUE)

#c.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Narcolepsy/Former")
write.csv(mod_ME_2_or,"No_UKB_Narcolepsy_former_MVMR_Egger.csv", row.names = TRUE)

#d.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Narcolepsy/Never")
write.csv(mod_ME_2_or,"No_UKB_Narcolepsy_never_MVMR_Egger.csv", row.names = TRUE)
...
#a.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Narcolepsy/Current")
write.csv(res_w_CIs,"No_UKB_Narcolepsy_current_MVMR.csv", row.names = TRUE)

#b.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Narcolepsy/Ever")
write.csv(res_w_CIs,"No_UKB_Narcolepsy_ever_MVMR.csv", row.names = TRUE)

#c.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Narcolepsy/Former")
write.csv(res_w_CIs,"No_UKB_Narcolepsy_former_MVMR.csv", row.names = TRUE)

#d.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Narcolepsy/Never")
write.csv(res_w_CIs,"No_UKB_Narcolepsy_never_MVMR.csv", row.names = TRUE)
...
write.csv(Fstat,"No_UKB_Narcolepsy_current_MVMR_FStat.csv", row.names = TRUE)
write.csv(Fstat,"No_UKB_Narcolepsy_ever_MVMR_FStat.csv", row.names = TRUE)
write.csv(Fstat,"No_UKB_Narcolepsy_former_MVMR_FStat.csv", row.names = TRUE)
write.csv(Fstat,"No_UKB_Narcolepsy_never_MVMR_FStat.csv", row.names = TRUE)
...
write.csv(ptr,"No_UKB_Narcolepsy_current_MVMR_Qstat.csv", row.names = TRUE)
write.csv(ptr,"No_UKB_Narcolepsy_ever_MVMR_Qstat.csv", row.names = TRUE)
write.csv(ptr,"No_UKB_Narcolepsy_former_MVMR_Qstat.csv", row.names = TRUE)
write.csv(ptr,"No_UKB_Narcolepsy_never_MVMR_Qstat.csv", row.names = TRUE)

# MVMR No UKB: Getting up
# Running straight after Chronotype script so exposure data is already ready
...
getting_up_current <- read_outcome_data(
  "GWASofGettingUpInCurrentSmokers_imputed.txt",
...
setwd("~/Desktop/MP1/Project portal/data/Unzipped stratified UK Biobank data for MVMR/Getting up")

#b. Ever smokers
memory.limit(size = 80000)
getting_up_ever <- read_outcome_data(
  "GWASofGettingUpInEverSmokers_imputed.txt",
  snps = Exposures_H$SNP,
  sep="\t",
  snp_col = "SNP",
  beta_col = "BETA",
...
setwd("~/Desktop/MP1/Project portal/data/Unzipped stratified UK Biobank data for MVMR/Getting up")
memory.limit(size = 80000)
getting_up_former <- read_outcome_data(
  "GWASofGettingUpInFormerSmokers_imputed.txt",
  snps = Exposures_H$SNP,
  sep="\t",
  snp_col = "SNP",
  beta_col = "BETA",
...
setwd("~/Desktop/MP1/Project portal/data/Unzipped stratified UK Biobank data for MVMR/Getting up")
memory.limit(size = 80000)
getting_up_never <- read_outcome_data(
  "GWASofGettingUpInNeverSmokers_imputed.txt",
  snps = Exposures_H$SNP,
  sep="\t",
  snp_col = "SNP",
  beta_col = "BETA",
...
#a.
mvdat <- mv_harmonise_data(Exposures_H, getting_up_current, harmonise_strictness = 2)
mvdat_1<- harmonise_data(Exposures_H, getting_up_current)
mvdat_1<- mvdat_1[mvdat_1$mr_keep== TRUE, ]
str(mvdat_1)

#b.
mvdat <- mv_harmonise_data(Exposures_H, getting_up_ever, harmonise_strictness = 2)
mvdat_1<- harmonise_data(Exposures_H, getting_up_ever)
mvdat_1<- mvdat_1[mvdat_1$mr_keep== TRUE, ]
str(mvdat_1)

#c.
mvdat <- mv_harmonise_data(Exposures_H, getting_up_former, harmonise_strictness = 2)
mvdat_1<- harmonise_data(Exposures_H, getting_up_former)
mvdat_1<- mvdat_1[mvdat_1$mr_keep== TRUE, ]
str(mvdat_1)

#d.
mvdat <- mv_harmonise_data(Exposures_H, getting_up_never, harmonise_strictness = 2)
mvdat_1<- harmonise_data(Exposures_H, getting_up_never)
mvdat_1<- mvdat_1[mvdat_1$mr_keep== TRUE, ]
str(mvdat_1)
...
#a.
proxy_needed3 <- data.frame(setdiff(EXP1_H$SNP, getting_up_current$SNP))

#b.
proxy_needed3 <- data.frame(setdiff(EXP1_H$SNP, getting_up_ever$SNP))

#c.
proxy_needed3 <- data.frame(setdiff(EXP1_H$SNP, getting_up_former$SNP))

#d.
proxy_needed3 <- data.frame(setdiff(EXP1_H$SNP, getting_up_never$SNP))
...
#a.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Getting up/Current")
write.csv(mod_ME_2_or,"No_UKB_Getting_up_current_MVMR_Egger.csv", row.names = TRUE)

#b.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Getting up/Ever")
write.csv(mod_ME_2_or,"No_UKB_Getting_up_ever_MVMR_Egger.csv", row.names = TRUE)

#c.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Getting up/Former")
write.csv(mod_ME_2_or,"No_UKB_Getting_up_former_MVMR_Egger.csv", row.names = TRUE)

#d.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Getting up/Never")
write.csv(mod_ME_2_or,"No_UKB_Getting_up_never_MVMR_Egger.csv", row.names = TRUE)
...
#a.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Getting up/Current")
write.csv(res_w_CIs,"No_UKB_Getting_up_current_MVMR.csv", row.names = TRUE)

#b.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Getting up/Ever")
write.csv(res_w_CIs,"No_UKB_Getting_up_ever_MVMR.csv", row.names = TRUE)

#c.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Getting up/Former")
write.csv(res_w_CIs,"No_UKB_Getting_up_former_MVMR.csv", row.names = TRUE)

#d.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Getting up/Never")
write.csv(res_w_CIs,"No_UKB_Getting_up_never_MVMR.csv", row.names = TRUE)
...
write.csv(Fstat,"No_UKB_Getting_up_current_MVMR_FStat.csv", row.names = TRUE)
write.csv(Fstat,"No_UKB_Getting_up_ever_MVMR_FStat.csv", row.names = TRUE)
write.csv(Fstat,"No_UKB_Getting_up_former_MVMR_FStat.csv", row.names = TRUE)
write.csv(Fstat,"No_UKB_Getting_up_never_MVMR_FStat.csv", row.names = TRUE)
...
write.csv(ptr,"No_UKB_Getting_up_current_MVMR_Qstat.csv", row.names = TRUE)
write.csv(ptr,"No_UKB_Getting_up_ever_MVMR_Qstat.csv", row.names = TRUE)
write.csv(ptr,"No_UKB_Getting_up_former_MVMR_Qstat.csv", row.names = TRUE)
write.csv(ptr,"No_UKB_Getting_up_never_MVMR_Qstat.csv", row.names = TRUE)
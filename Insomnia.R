...
insomnia_current <- read_outcome_data(
  "GWASofInsomniaInCurrentSmokers_imputed.txt",
...
setwd("~/Desktop/MP1/Project portal/data/Unzipped stratified UK Biobank data for MVMR/Insomnia")

#b. Ever smokers
memory.limit(size = 80000)
insomnia_ever <- read_outcome_data(
  "GWASofInsomniaInEverSmokers_imputed.txt",
  snps = Exposures_H$SNP,
  sep="\t",
  snp_col = "SNP",
  beta_col = "BETA",
...
setwd("~/Desktop/MP1/Project portal/data/Unzipped stratified UK Biobank data for MVMR/Insomnia")
memory.limit(size = 80000)
insomnia_former <- read_outcome_data(
  "GWASofInsomniaInFormerSmokers_imputed.txt",
  snps = Exposures_H$SNP,
  sep="\t",
  snp_col = "SNP",
  beta_col = "BETA",
...
setwd("~/Desktop/MP1/Project portal/data/Unzipped stratified UK Biobank data for MVMR/Insomnia")
memory.limit(size = 80000)
insomnia_never <- read_outcome_data(
  "GWASofInsomniaInNeverSmokers_imputed.txt",
  snps = Exposures_H$SNP,
  sep="\t",
  snp_col = "SNP",
  beta_col = "BETA",
...
#a.
mvdat <- mv_harmonise_data(Exposures_H, insomnia_current, harmonise_strictness = 2)
mvdat_1<- harmonise_data(Exposures_H, insomnia_current)
mvdat_1<- mvdat_1[mvdat_1$mr_keep== TRUE, ]
str(mvdat_1)

#b.
mvdat <- mv_harmonise_data(Exposures_H, insomnia_ever, harmonise_strictness = 2)
mvdat_1<- harmonise_data(Exposures_H, insomnia_ever)
mvdat_1<- mvdat_1[mvdat_1$mr_keep== TRUE, ]
str(mvdat_1)

#c.
mvdat <- mv_harmonise_data(Exposures_H, insomnia_former, harmonise_strictness = 2)
mvdat_1<- harmonise_data(Exposures_H, insomnia_former)
mvdat_1<- mvdat_1[mvdat_1$mr_keep== TRUE, ]
str(mvdat_1)

#d.
mvdat <- mv_harmonise_data(Exposures_H, insomnia_never, harmonise_strictness = 2)
mvdat_1<- harmonise_data(Exposures_H, insomnia_never)
mvdat_1<- mvdat_1[mvdat_1$mr_keep== TRUE, ]
str(mvdat_1)
...
#a.
proxy_needed3 <- data.frame(setdiff(EXP1_H$SNP, insomnia_current$SNP))

#b.
proxy_needed3 <- data.frame(setdiff(EXP1_H$SNP, insomnia_ever$SNP))

#c.
proxy_needed3 <- data.frame(setdiff(EXP1_H$SNP, insomnia_former$SNP))

#d.
proxy_needed3 <- data.frame(setdiff(EXP1_H$SNP, insomnia_never$SNP))
...
#a.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Insomnia/Current")
write.csv(mod_ME_2_or,"No_UKB_Insomnia_current_MVMR_Egger.csv", row.names = TRUE)

#b.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Insomnia/Ever")
write.csv(mod_ME_2_or,"No_UKB_Insomnia_ever_MVMR_Egger.csv", row.names = TRUE)

#c.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Insomnia/Former")
write.csv(mod_ME_2_or,"No_UKB_Insomnia_former_MVMR_Egger.csv", row.names = TRUE)

#d.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Insomnia/Never")
write.csv(mod_ME_2_or,"No_UKB_Insomnia_never_MVMR_Egger.csv", row.names = TRUE)
...
#a.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Insomnia/Current")
write.csv(res_w_CIs,"No_UKB_Insomnia_current_MVMR.csv", row.names = TRUE)

#b.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Insomnia/Ever")
write.csv(res_w_CIs,"No_UKB_Insomnia_ever_MVMR.csv", row.names = TRUE)

#c.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Insomnia/Former")
write.csv(res_w_CIs,"No_UKB_Insomnia_former_MVMR.csv", row.names = TRUE)

#d.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Insomnia/Never")
write.csv(res_w_CIs,"No_UKB_Insomnia_never_MVMR.csv", row.names = TRUE)
...
write.csv(Fstat,"No_UKB_Insomnia_current_MVMR_FStat.csv", row.names = TRUE)
write.csv(Fstat,"No_UKB_Insomnia_ever_MVMR_FStat.csv", row.names = TRUE)
write.csv(Fstat,"No_UKB_Insomnia_former_MVMR_FStat.csv", row.names = TRUE)
write.csv(Fstat,"No_UKB_Insomnia_never_MVMR_FStat.csv", row.names = TRUE)
...
write.csv(ptr,"No_UKB_Insomnia_current_MVMR_Qstat.csv", row.names = TRUE)
write.csv(ptr,"No_UKB_Insomnia_ever_MVMR_Qstat.csv", row.names = TRUE)
write.csv(ptr,"No_UKB_Insomnia_former_MVMR_Qstat.csv", row.names = TRUE)
write.csv(ptr,"No_UKB_Insomnia_never_MVMR_Qstat.csv", row.names = TRUE)

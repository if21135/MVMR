...
napping_current <- read_outcome_data(
  "GWASofNappingInCurrentSmokers_imputed.txt",
...
setwd("~/Desktop/MP1/Project portal/data/Unzipped stratified UK Biobank data for MVMR/Napping")

#b. Ever smokers
memory.limit(size = 80000)
napping_ever <- read_outcome_data(
  "GWASofNappingInEverSmokers_imputed.txt",
  snps = Exposures_H$SNP,
  sep="\t",
  snp_col = "SNP",
  beta_col = "BETA",
...
setwd("~/Desktop/MP1/Project portal/data/Unzipped stratified UK Biobank data for MVMR/Napping")
memory.limit(size = 80000)
napping_former <- read_outcome_data(
  "GWASofNappingInFormerSmokers_imputed.txt",
  snps = Exposures_H$SNP,
  sep="\t",
  snp_col = "SNP",
  beta_col = "BETA",
...
setwd("~/Desktop/MP1/Project portal/data/Unzipped stratified UK Biobank data for MVMR/Napping")
memory.limit(size = 80000)
napping_never <- read_outcome_data(
  "GWASofNappingInNeverSmokers_imputed.txt",
  snps = Exposures_H$SNP,
  sep="\t",
  snp_col = "SNP",
  beta_col = "BETA",
...
#a.
mvdat <- mv_harmonise_data(Exposures_H, napping_current, harmonise_strictness = 2)
mvdat_1<- harmonise_data(Exposures_H, napping_current)
mvdat_1<- mvdat_1[mvdat_1$mr_keep== TRUE, ]
str(mvdat_1)

#b.
mvdat <- mv_harmonise_data(Exposures_H, napping_ever, harmonise_strictness = 2)
mvdat_1<- harmonise_data(Exposures_H, napping_ever)
mvdat_1<- mvdat_1[mvdat_1$mr_keep== TRUE, ]
str(mvdat_1)

#c.
mvdat <- mv_harmonise_data(Exposures_H, napping_former, harmonise_strictness = 2)
mvdat_1<- harmonise_data(Exposures_H, napping_former)
mvdat_1<- mvdat_1[mvdat_1$mr_keep== TRUE, ]
str(mvdat_1)

#d.
mvdat <- mv_harmonise_data(Exposures_H, napping_never, harmonise_strictness = 2)
mvdat_1<- harmonise_data(Exposures_H, napping_never)
mvdat_1<- mvdat_1[mvdat_1$mr_keep== TRUE, ]
str(mvdat_1)
...
#a.
proxy_needed3 <- data.frame(setdiff(EXP1_H$SNP, napping_current$SNP))

#b.
proxy_needed3 <- data.frame(setdiff(EXP1_H$SNP, napping_ever$SNP))

#c.
proxy_needed3 <- data.frame(setdiff(EXP1_H$SNP, napping_former$SNP))

#d.
proxy_needed3 <- data.frame(setdiff(EXP1_H$SNP, napping_never$SNP))
...
#a.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Napping/Current")
write.csv(mod_ME_2_or,"No_UKB_Napping_current_MVMR_Egger.csv", row.names = TRUE)

#b.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Napping/Ever")
write.csv(mod_ME_2_or,"No_UKB_Napping_ever_MVMR_Egger.csv", row.names = TRUE)

#c.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Napping/Former")
write.csv(mod_ME_2_or,"No_UKB_Napping_former_MVMR_Egger.csv", row.names = TRUE)

#d.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Napping/Never")
write.csv(mod_ME_2_or,"No_UKB_Napping_never_MVMR_Egger.csv", row.names = TRUE)
...
#a.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Napping/Current")
write.csv(res_w_CIs,"No_UKB_Napping_current_MVMR.csv", row.names = TRUE)

#b.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Napping/Ever")
write.csv(res_w_CIs,"No_UKB_Napping_ever_MVMR.csv", row.names = TRUE)

#c.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Napping/Former")
write.csv(res_w_CIs,"No_UKB_Napping_former_MVMR.csv", row.names = TRUE)

#d.
setwd("~/Desktop/MP1/Project portal/results/MVMR analyses/MVMR no UKB/Napping/Never")
write.csv(res_w_CIs,"No_UKB_Napping_never_MVMR.csv", row.names = TRUE)
...
write.csv(Fstat,"No_UKB_Napping_current_MVMR_FStat.csv", row.names = TRUE)
write.csv(Fstat,"No_UKB_Napping_ever_MVMR_FStat.csv", row.names = TRUE)
write.csv(Fstat,"No_UKB_Napping_former_MVMR_FStat.csv", row.names = TRUE)
write.csv(Fstat,"No_UKB_Napping_never_MVMR_FStat.csv", row.names = TRUE)
...
write.csv(ptr,"No_UKB_Napping_current_MVMR_Qstat.csv", row.names = TRUE)
write.csv(ptr,"No_UKB_Napping_ever_MVMR_Qstat.csv", row.names = TRUE)
write.csv(ptr,"No_UKB_Napping_former_MVMR_Qstat.csv", row.names = TRUE)
write.csv(ptr,"No_UKB_Napping_never_MVMR_Qstat.csv", row.names = TRUE)
